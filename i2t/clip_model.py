...
class ResidualAttentionBlock(nn.Module):
    ...
    def attention(self, x: torch.Tensor, key_padding_mask=None):
        ...
        return self.attn(x, x, x, key_padding_mask=key_padding_mask, need_weights=False, attn_mask=self.attn_mask)[0]
...
class Transformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, key_padding_mask=None):
        ...
        return x
        # return self.resblocks(x, key_padding_mask=key_padding_mask)
