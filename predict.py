...
class I2TInferer(object):
    ...
    def encode_images(self, images: Iterable[Image.Image]) -> torch.Tensor:
        ...
        for chunk in more_itertools.chunked(images, 10):
            ...
            chunk_image_features = self.model.encoders['image'](images_torch)
